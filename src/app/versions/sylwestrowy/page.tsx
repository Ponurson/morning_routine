...
const ROUTINE_STEPS: RoutineStep[] = [
  ...
  },
  {
    ...
    description:
      "Wybierz strój, popraw fryzurę i dodaj odrobinę blasku.",
    icon: "mask",
...
export default function SylwestrowyVersion() {
  ...
  return (
    <div
      className={`${heading.variable} ${body.variable} ny-root relative min-h-screen overflow-hidden bg-[#09050f] text-[#fdf7ec]`}
    >
      <style jsx global>{`
        .ny-root {
        ...
        .ny-root .firework {
          ...
          opacity: 0;
          animation: firework-burst 4.8s ease-out infinite;
        }

        .ny-root .firework span {
          position: absolute;
          left: 50%;
          top: 50%;
          width: 4px;
          ...
          background: linear-gradient(
            180deg,
            #fff1d6 0%,
            rgba(255, 140, 140, 0) 100%
          );
          filter: drop-shadow(0 0 12px rgba(255, 210, 140, 0.6));
        }

        .ny-root .firework span:nth-child(3n) {
          height: 44px;
        }

        .ny-root .firework span:nth-child(4n) {
          height: 60px;
        }

        .ny-root .firework span:nth-child(5n) {
          height: 36px;
        }

        .ny-root .firework span:nth-child(1) {
          transform: translate(-50%, -50%) rotate(0deg);
        }
        .ny-root .firework span:nth-child(2) {
          transform: translate(-50%, -50%) rotate(30deg);
        }
        .ny-root .firework span:nth-child(3) {
          transform: translate(-50%, -50%) rotate(60deg);
        }
        .ny-root .firework span:nth-child(4) {
          transform: translate(-50%, -50%) rotate(90deg);
        }
        .ny-root .firework span:nth-child(5) {
          transform: translate(-50%, -50%) rotate(120deg);
        }
        .ny-root .firework span:nth-child(6) {
          transform: translate(-50%, -50%) rotate(150deg);
        }
        .ny-root .firework span:nth-child(7) {
          transform: translate(-50%, -50%) rotate(180deg);
        }
        .ny-root .firework span:nth-child(8) {
          transform: translate(-50%, -50%) rotate(210deg);
        }
        .ny-root .firework span:nth-child(9) {
          transform: translate(-50%, -50%) rotate(240deg);
        }
        .ny-root .firework span:nth-child(10) {
          transform: translate(-50%, -50%) rotate(270deg);
        }
        .ny-root .firework span:nth-child(11) {
          transform: translate(-50%, -50%) rotate(300deg);
        }
        .ny-root .firework span:nth-child(12) {
          transform: translate(-50%, -50%) rotate(330deg);
        }

        .ny-root .firework::before,
        .ny-root .firework::after {
          content: "";
          position: absolute;
          left: 50%;
          top: 50%;
          ...
          opacity: 0.9;
          box-shadow:
            0 0 18px rgba(255, 213, 154, 0.8),
            0 0 32px rgba(255, 140, 140, 0.6);
        }
        ...
        .ny-root .firework::after {
          ...
          background: #ff8c8c;
          box-shadow:
            -22px -8px 0 -2px rgba(255, 214, 160, 0.9),
            18px -16px 0 -1px rgba(255, 241, 214, 0.9),
            -6px 20px 0 -1px rgba(255, 140, 140, 0.9),
            24px 10px 0 -2px rgba(255, 200, 150, 0.9),
            -18px 18px 0 -2px rgba(255, 214, 160, 0.9);
        }
        ...
        .ny-root .reward-confetti span {
          ...
          box-shadow: 0 0 12px rgba(255, 230, 190, 0.55);
        ...
        .ny-root .firework-burst {
          ...
          height: 70px;
          opacity: 0;
          animation: firework-bloom 1.1s ease-out forwards;
        }

        .ny-root .firework-burst span {
          position: absolute;
          left: 50%;
          top: 50%;
          width: 4px;
          height: 20px;
          border-radius: 9999px;
          background: linear-gradient(180deg, #fff1d6 0%, #ff9f74 100%);
          transform-origin: center 24px;
          opacity: 0.9;
        }

        .ny-root .firework-burst span:nth-child(1) {
          transform: translate(-50%, -50%) rotate(0deg);
        }
        .ny-root .firework-burst span:nth-child(2) {
          transform: translate(-50%, -50%) rotate(45deg);
        }
        .ny-root .firework-burst span:nth-child(3) {
          transform: translate(-50%, -50%) rotate(90deg);
        }
        .ny-root .firework-burst span:nth-child(4) {
          transform: translate(-50%, -50%) rotate(135deg);
        }
        .ny-root .firework-burst span:nth-child(5) {
          transform: translate(-50%, -50%) rotate(180deg);
        }
        .ny-root .firework-burst span:nth-child(6) {
          transform: translate(-50%, -50%) rotate(225deg);
        }
        .ny-root .firework-burst span:nth-child(7) {
          transform: translate(-50%, -50%) rotate(270deg);
        }
        .ny-root .firework-burst span:nth-child(8) {
      ...
      <main className="relative z-10 mx-auto flex min-h-screen w-full max-w-2xl flex-col gap-9 px-4 pb-24 pt-12 sm:px-6">
        <div className="flex justify-center">
          <Link
            href="/"
            className="inline-flex items-center rounded-full border border-white/20 bg-white/[0.08] px-4 py-2 text-xs font-semibold uppercase tracking-[0.3em] text-[#ffe3b1] shadow-sm backdrop-blur transition hover:bg-white/[0.12]"
          >
            Wróć do stylu manuskryptu
          </Link>
        </div>
          ...
          {ROUTINE_STEPS.map((step, index) => {
            ...
            return (
              ...
              >
                ...
                {isComplete ? (
                  <div key={burstKey} className="firework-burst" aria-hidden>
                    {Array.from({ length: 8 }).map((_, fireworkIndex) => (
                      <span key={fireworkIndex} />
                    ))}
                  </div>
                ) : null}
...
function RewardCard({ onReset }: { onReset: () => void }) {
  return (
